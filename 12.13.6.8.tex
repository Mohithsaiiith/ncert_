...
\end{align}
Dividing \pr{A} on both sides of equation (\eqref{eq:1})
\begin{align}
...
But given \pr{B|A} $<$ \pr{B}\ so option \ref{A} is incorrect

   \item from equation \eqref{eq:2} we have
\begin{align}
	 \pr{AB} > \pr{A}\pr{B}
\end{align}
Therefore, option \ref{B} is incorrect   
...
Therefore, option \ref{C} is correct

    \item from equation \eqref{eq:3} we have
\begin{align}
	 \pr{B|A} > \pr{B}
\end{align}
...
Therefore, option \ref{D} is incorrect
