...
\end{align}
Dividing \pr{A} on both sides of \eqref{eq:1}
\begin{align}
	=\frac{\pr{AB}}{\pr{A}} > \frac{\pr{A}\pr{B}}{\pr{A}}
\end{align}
\begin{align}
	\label{eq:2}
	=\pr{B|A} > \pr{B}
...
But given \pr{B|A} $<$ \pr{B}\ so option (A) is incorrect

   \item from equation \eqref{eq:1} we have
\begin{align}
	=\pr{AB} > \pr{A}\pr{B}
\end{align}
